# AGENTS.md — Conventions for AI-assisted work in this repo

This file tells Codex (or any AI assistant) how to work in the Soluven marketing website repo. Read `REQUIREMENTS.md`, `DESIGN.md`, and `ARCHITECTURE.md` first for full context.
